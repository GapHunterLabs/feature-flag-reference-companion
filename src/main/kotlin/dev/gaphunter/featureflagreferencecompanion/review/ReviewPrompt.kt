package dev.gaphunter.featureflagreferencecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.featureflagreferencecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.featureflagreferencecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Feature Flag Reference Companion"
    ...
    // https://plugins.jetbrains.com/plugin/<id>-feature-flag-reference-companion/reviews once the
